  ...
  return (
    <section className="relative overflow-hidden border-b border-zinc-200 dark:border-zinc-800">
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-24 lg:py-32">
        ...
        <h1 className="animate-on-load-delay-1 mt-8 max-w-3xl text-4xl font-bold tracking-tight text-zinc-900 sm:text-5xl lg:text-6xl dark:text-zinc-50">
        ...
        <p className="animate-on-load-delay-2 mt-6 max-w-2xl text-lg leading-8 text-zinc-600 dark:text-zinc-400">
        ...
        <div className="animate-on-load-delay-3 mt-10 flex flex-col gap-4 sm:flex-row">
          {primary ? (
            <Link
              href={primary.href}
              className="inline-flex h-12 items-center justify-center rounded-full bg-zinc-900 px-8 text-sm font-semibold text-white transition-all duration-200 hover:scale-[1.02] hover:bg-zinc-700 active:scale-[0.98] dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-300"
            >
          ...
          <Link
            href="/templates"
            className="inline-flex h-12 items-center justify-center rounded-full border border-zinc-300 bg-white px-8 text-sm font-semibold text-zinc-900 transition-all duration-200 hover:scale-[1.02] hover:bg-zinc-50 active:scale-[0.98] dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:hover:bg-zinc-800"
          >
            View all roadmaps
          </Link>
        </div>
        ...
        {stats.collectionCount > 0 && (
          <dl className="animate-on-load-delay-4 mt-12 grid grid-cols-3 gap-3 border-t border-zinc-200 pt-8 dark:border-zinc-800 sm:mt-16 sm:max-w-lg sm:gap-6 sm:pt-10">
            <div>
